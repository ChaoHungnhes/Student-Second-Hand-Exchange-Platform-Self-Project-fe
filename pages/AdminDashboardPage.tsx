...
const AdminDashboardPage: React.FC = () => {
  ...
  if (currentUser?.roles[0] !== UserRole.ADMIN) {
    return (
      <div className="p-20 text-center font-black text-red-600 uppercase tracking-widest">
        Truy cập bị từ chối
      </div>
    );
  }
      ...
      <aside className="lg:w-64 flex-shrink-0">
        <div className="bg-white rounded-[40px] border border-gray-100 p-5 shadow-sm sticky top-24">
          <div className="mb-10 px-4 py-2">
            <h2 className="text-xs font-black text-indigo-300 uppercase tracking-[0.2em]">
              Hệ thống
            </h2>
